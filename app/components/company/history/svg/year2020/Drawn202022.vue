<template>
  <svg xmlns="http://www.w3.org/2000/svg" width="231.209" height="292.92" viewBox="0 0 231.209 292.92">
    <path id='pPath202022' stroke-width='1'
          stroke='#ff2d32'
          class='drawn-path'
...
export default {
  ...
  methods: {
    handleScroll() {
      ...
      if (
        this.isAnyPartOfElementInViewport(document.getElementById('year2020'))
      ) {
        if (
          this.getProcentOfSectionToTop(
            document.getElementById('year2020')
          ) > procentOfTopSection
        ) {
          document.getElementById('pPath202022').classList.add('path')
        }
      }
    }
  }
